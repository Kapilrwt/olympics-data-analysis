...
An interactive data analysis project exploring Olympic Games data (1896–2016).
Built using **Streamlit** and **Plotly** to visualize trends, performance, and athlete insights.
...
```bash
git clone https://github.com/Sumit-Maulekhi/olympics-data-analysis.git
cd your-repo
